...
app.get("/health", (_req, res) => res.json({ ok: true, version: "1.1.0", videos: ["hero-reel.mp4","fresh-prep.mp4","captains-pantry.mp4","brunswick-drone.mp4"] }));
app.use((_req, res) => res.sendFile(path.join(__dirname, "index.html")));
app.listen(PORT, "0.0.0.0", () => console.log(`BHFC Website v1.1 Dual Live Menu running on port ${PORT}`));
